<nav class="page-sidebar">
            <div class="slimScrollDiv" style="position: relative; overflow: hidden; width: auto; height: 100%;"><ul class="side-menu metismenu scroller" style="overflow: hidden; width: auto; height: 100%;">
                <li class="active">
